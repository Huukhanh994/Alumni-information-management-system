...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                    <h3 class="box-title">Majors Table</h3>
                    <br>
                    <a href="{{route('major/create')}}" class="btn btn-success waves-effect waves-light m-r-10">Add</a>
                    <br>
                    <br>
                    <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('major/destroy', $item->major_id) }}" method="post" class="delete_form">
                                                <a href="{{ action('Master\MajorController@edit',$item->major_id) }}" class="btn btn-warning">Edit</a>
                                                @csrf
